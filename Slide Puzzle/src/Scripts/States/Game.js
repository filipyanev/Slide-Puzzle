...
(function (SlidingGame) {
    var Game = (function (_super) {
        ...
        Game.prototype.create = function () {
            var slide = this.game.add.audio('slide');
            var list;
            var wrightList;
            var myPosX;
            var myPosY;
            ...
            var noneRowIndex = 4;
            var noneColIndex = 4;
            var myBlockWidth = innerWidth * 0.25;
            ...
            wrightList = [["out", "out", "out", "out", "out", "out"],
                ...
                ["out", "out", "out", "out", "out", "out"]];
            /*  +++++++++++++++++++++++++++++++++++=  CREATE BLOCKS ++++++++++++++++++++++++++++++++++++++++++++++++= */
            var bl1 = this.game.add.sprite(this.game.world.centerX - 2 * myBlockWidth, this.game.world.centerY - 2 * myBlockWidth, 'block1');
            bl1.anchor.setTo(0, 0);
            bl1.width = myBlockWidth;
            bl1.height = myBlockWidth;
            bl1.alpha = 0.8;
            var bl2 = this.game.add.sprite(this.game.world.centerX - myBlockWidth, this.game.world.centerY - 2 * myBlockWidth, 'block2');
            bl2.anchor.setTo(0, 0);
            bl2.width = myBlockWidth;
            bl2.height = myBlockWidth;
            bl2.alpha = 0.8;
            var bl3 = this.game.add.sprite(this.game.world.centerX, this.game.world.centerY - 2 * myBlockWidth, 'block3');
            bl3.anchor.setTo(0, 0);
            bl3.width = myBlockWidth;
            bl3.height = myBlockWidth;
            bl3.alpha = 0.8;
            var bl4 = this.game.add.sprite(this.game.world.centerX + myBlockWidth, this.game.world.centerY - 2 * myBlockWidth, 'block4');
            bl4.anchor.setTo(0, 0);
            bl4.width = myBlockWidth;
            bl4.height = myBlockWidth;
            bl4.alpha = 0.8;
            /* +++++++++++++++++++++++   SECOND ROW        ++++++++++++++++++++++++++++++++= */
            var bl5 = this.game.add.sprite(this.game.world.centerX - 2 * myBlockWidth, this.game.world.centerY - myBlockWidth, 'block5');
            bl5.anchor.setTo(0, 0);
            bl5.width = myBlockWidth;
            bl5.height = myBlockWidth;
            bl5.alpha = 0.8;
            var bl6 = this.game.add.sprite(this.game.world.centerX - myBlockWidth, this.game.world.centerY - myBlockWidth, 'block6');
            bl6.anchor.setTo(0, 0);
            bl6.width = myBlockWidth;
            bl6.height = myBlockWidth;
            bl6.alpha = 0.8;
            var bl7 = this.game.add.sprite(this.game.world.centerX, this.game.world.centerY - myBlockWidth, 'block7');
            bl7.anchor.setTo(0, 0);
            bl7.width = myBlockWidth;
            bl7.height = myBlockWidth;
            bl7.alpha = 0.8;
            var bl8 = this.game.add.sprite(this.game.world.centerX + myBlockWidth, this.game.world.centerY - myBlockWidth, 'block8');
            bl8.anchor.setTo(0, 0);
            bl8.width = myBlockWidth;
            bl8.height = myBlockWidth;
            bl8.alpha = 0.8;
            /*  ++++++++++++++++++++++++++++== THIRD ROW ++++++++++++++++++= */
            var bl9 = this.game.add.sprite(this.game.world.centerX - 2 * myBlockWidth, this.game.world.centerY, 'block9');
            bl9.anchor.setTo(0, 0);
            bl9.width = myBlockWidth;
            bl9.height = myBlockWidth;
            bl9.alpha = 0.8;
            var bl10 = this.game.add.sprite(this.game.world.centerX - myBlockWidth, this.game.world.centerY, 'block10');
            bl10.anchor.setTo(0, 0);
            bl10.width = myBlockWidth;
            bl10.height = myBlockWidth;
            bl10.alpha = 0.8;
            var bl11 = this.game.add.sprite(this.game.world.centerX, this.game.world.centerY, 'block11');
            bl11.anchor.setTo(0, 0);
            bl11.width = myBlockWidth;
            bl11.height = myBlockWidth;
            bl11.alpha = 0.8;
            var bl12 = this.game.add.sprite(this.game.world.centerX + myBlockWidth, this.game.world.centerY, 'block12');
            bl12.anchor.setTo(0, 0);
            bl12.width = myBlockWidth;
            bl12.height = myBlockWidth;
            bl12.alpha = 0.8;
            /* +++++++++++++++++++++== FOURTH ROW +++++++++++++++= */
            var bl13 = this.game.add.sprite(this.game.world.centerX - 2 * myBlockWidth, this.game.world.centerY + myBlockWidth, 'block13');
            bl13.anchor.setTo(0, 0);
            bl13.width = myBlockWidth;
            bl13.height = myBlockWidth;
            bl13.alpha = 0.8;
            var bl14 = this.game.add.sprite(this.game.world.centerX - myBlockWidth, this.game.world.centerY + myBlockWidth, 'block14');
            bl14.anchor.setTo(0, 0);
            bl14.width = myBlockWidth;
            bl14.height = myBlockWidth;
            bl14.alpha = 0.8;
            var bl15 = this.game.add.sprite(this.game.world.centerX, this.game.world.centerY + myBlockWidth, 'block15');
            ...
            function randomChangePosition() {
                var indList = [1, 2, 3, 4];
                var randShit = Math.floor(Math.random() * indList.length);
                var fInd = indList[randShit];
